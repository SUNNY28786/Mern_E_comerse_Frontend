...
useEffect(() => {
  ...
  return (
      <>
          <div className="w-full h-1 bg-orange-500 mt-12">
              <div className="w-full h-1 bg-purple-500/30"></div>

               <>
    <>
      <div className="min-h-screen bg-[#070d18] text-white py-10 pt-2">
        <div className="max-w-7xl mx-auto px-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-7">
            ...
            {searchProduct?.map((product) => (
              <div
                key={product._id}
                className="bg-[#151c2c] rounded-2xl  overflow-hidden group transition-all duration-300 hover:scale-[1.03] hover:shadow-[0_0_20px_rgba(249,115,22,0.35)]"
              >
                {/* Image */}
  ...
  <span className="absolute left-0 bottom-0 bg-orange-600 text-white px-5 py-2 text-sm font-bold rounded-tr-xl">
    ...
    <div className="px-4 py-3">
      ...
      {/* Button */}
      <button className="w-full mt-2 bg-orange-600 hover:bg-orange-500 text-white py-3 rounded-full font-bold transition duration-300">
        🛒 ADD TO CART
      </button>
